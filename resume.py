      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a class="nav-link" href="C:\\Users\\lenovo\\Desktop\\TCS\\MLOps Udemy\\Streamlit\\my app\\my_resume.pdf" download>
...
if __name__ == '__main__':
    ...
    #show_component_with_delay(header_and_intro, delay=0.0)
    navigation_bar()
    sidebar()
    main_content()
    gradient('#B5B5B5','#008080','e0fbfc',f"Greetings, I am Irshad", markdown_text)
